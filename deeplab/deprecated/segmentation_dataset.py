...
#_ADL_SEG_INFORMATION = DatasetDescriptor(
#    splits_to_sizes={
#        'train': 2947, # number of file in the train folder
#        'trainval': 3000,
#        'val': 63,
#    },
...
_ADL_PCAMI_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 2947, # number of file in the train folder
        'trainval': 3000,
        'val': 63,
...
_ADL_PERTIGA_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 89, # number of file in the train folder
        'trainval': 94,
        'val': 10,
    },
    num_classes=3, # number of classes in your dataset
...
_DATASETS_INFORMATION = {
    ...
    #'adl_seg':_ADL_SEG_INFORMATION,
    'adl_pertiga':_ADL_PERTIGA_INFORMATION,
    'adl_pcami':_ADL_PCAMI_INFORMATION,
}
